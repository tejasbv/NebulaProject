                          ...
                          child: Container(
                            ...
                            child: Column(
                              children: sectionsinfo == null
                                  ? []
                                  : [
                                      Container(padding: EdgeInsets.only(bottom: 50),width: MediaQuery.of(context).size.width -MediaQuery.of(context).size.width / 3-200 ,child: Text("⬇️⬇️choose a section to view more details⬇️⬇️", style: TextStyle(fontSize: 36, ),softWrap: true,textAlign: TextAlign.center,)),
